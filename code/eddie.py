...
pylab.savefig('../figs/eddie/%straces.pdf' % prefix)
#pylab.savefig('../figs/eddie/%straces-thick.pdf' % prefix)
...
pylab.savefig('../figs/eddie/%straces-pair.pdf' % prefix)
...
pylab.savefig('../figs/eddie/%scorrelation.pdf' % prefix)
...
a[3] = yt[-1]
pylab.axis(a)
pylab.savefig('../figs/eddie/%spermutations.pdf' % prefix)
...
pylab.xlabel('$\\log$ $u$\n', fontsize=fs)
pylab.savefig('../figs/eddie/%suniform.pdf' % prefix)
...
pylab.savefig('../figs/eddie/%shistogram.pdf' % prefix)
